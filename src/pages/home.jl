...
if ARGS[1] == "demo"
    ...
    __Note:__ Initial loading of the pages may take a while as the Julia programming language precompiles all plots. However, subsequent adaptions of the plots run relatively fast (considered the amount of data that needs to be handled and provided as interactive plots).\n
